...
public class MoveCamera : MonoBehaviour 
    ...
    public float SpeedMultiplyerOnShiftPressed = 30f;
    public float vitesse = 1.0f;

    private float moveUpDown;
    private float speedMultiplyer = 10f;
    ...
    void Update () 
        ...
        speedMultiplyer = Mathf.Lerp(speedMultiplyer, 10f, 0.1f);
        ...
        this.transform.position += this.transform.right * x * HorizontalVerticalSensitivity * speedMultiplyer * vitesse;
        this.transform.position += this.transform.forward * y* HorizontalVerticalSensitivity * speedMultiplyer * vitesse;
        this.transform.position += this.transform.up * moveUpDown* speedMultiplyer * vitesse;
        }
    }
